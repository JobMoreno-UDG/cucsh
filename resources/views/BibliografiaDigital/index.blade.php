...
@section('content')
<form class="row g-3 justify-content-justify" action="" method="POST">
  <div class="col-auto">
  ...
  <div class="col-sm-12 col-md-5 m-1 ms-auto">
      <a class="col-sm-12 col-auto btn btn-outline-dark" href="{{route('bibliografia_digital.registro')}}">Añadir Registro</a>
