...
@section('content')
<form action="{{route('cuadernos.create')}}" class="row justify-content-bettwen" method="POST">
    @csrf
    <div class="col-auto">
        <label for="clasificacion" class="form-label">Clasificación</label>
        <input type="text" name="clasificacion" name="clasificacion" id="clasificacion" class="form-control">
        @error('clasificacion')
        <small>{{$message}}</small>
        <br>
        @enderror
    ...
    <div class="col-8">
        ...
        <input class="form-control" name="titulo" title="titulo" id="titulo"/>
        @error('titulo')
        <small>{{$message}}</small>
        <br>
        @enderror
    ...
    <div class="col-auto">
        ...
        <input class="form-control"  type="text" name="resguardo" id="resguardo" >
    </div>
    <div class="col-8">
